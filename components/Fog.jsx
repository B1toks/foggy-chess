 ...
 */
export default function Fog({ visibility, lastMove, enemyPieceSquares }) {
  if (FOG_MODE === 'tier1') return <FogLayer visibility={visibility} />;
  return (
    <FogShader visibility={visibility} lastMove={lastMove} enemyPieceSquares={enemyPieceSquares} />
  );
}
