...
// Крок 13: 12 -> 16. A little finer step resolution reduces banding in the
// volume's own billow detail, requested alongside the frontier wobble above
// as "a bit more detail" — still the first lever to pull back down if a real
// GPU ever shows this is too expensive (see CLAUDE.md's "Headless browser").
export const FOG_MARCH_STEPS = 16;
