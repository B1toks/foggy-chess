...
// The two facts PromotionPicker is built on. Board asks isPromotion() before it
// commits a move, and isPromotion() reads `flags` — if either of these drifts in
// a future chess.js, the picker silently stops appearing and every promotion
